...
boton_nuevo = tk.Button (frame_inicio, text="Ingresar Nuevo Proyecto", bg="#35054C", fg="white",width=20,height=3) # esta funci´n crea el botón con el texto de Ingresar Nuevo Proyecto
